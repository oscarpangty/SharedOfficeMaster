...
def get_llm_decision(start_time,end_time,ac_preference):
    ...
    messages.append({"role": "user", "content": "Now start the AC. Set temperature based on previous info. Set mode between cooling and heating. Set fan speed between low, high and auto. Only output jason code in this format: {\"device\": {\"buildingId\": \"12345\", \"deviceId\": \"67890\", \"start_time\": \"{start_time}\",\"end_time\": \"{end_time}\",\"mode\": \"cooling\", \"targetTemp\": 22, \"fanSpeed\": \"high\"}} no comments"})
